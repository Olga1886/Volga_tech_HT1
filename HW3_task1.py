...
target_word = "князь"
target_chapter = 1
tf_idf_score = get_tf_idf(data, target_word, target_chapter)
print(f"TF-IDF for '{target_word}' in chapter {target_chapter}: {tf_idf_score}")

print(f"TF-IDF for 'свет' in chapter 20: {tf_idf_score}")
print(f"TF-IDF for 'Пьер' in chapter 20: {tf_idf_score}")
print(f"TF-IDF for 'дуб' in chapter 110: {tf_idf_score}")